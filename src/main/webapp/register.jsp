        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="login-box text-center">
                    <h3 class="login-title">Register to Elevate Media</h3>
                  <form action="Account" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group text-left">
                            ...
                            <input type="password" class="form-control" name="comnfirmPassword" required placeholder="Confrim Password">
                        </div>
                        <div class="form-group text-left">
                    ...
                    <p class="mt-3">Have an account? <a href="login.jsp">Login</a></p>
                </div>
                </div>
            </div>
        </div>
